        ...
        <CardContent className="pt-8">
          <div className="mb-8 flex flex-col items-center gap-3">
            ...
            <div className="text-center">
              ...
              <div className="mt-1 text-xs uppercase tracking-[0.3em] text-muted-foreground">Create your account</div>
            </div>
          </div>
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            {error && (
              <div className="rounded-md border border-destructive bg-destructive/10 px-3 py-2 text-sm text-red-300">{error}</div>
            )}
